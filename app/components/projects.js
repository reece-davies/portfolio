...
export default function Projects() {
  return (
    <section className="flex flex-col w-full py-10 gap-6">
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold pt-10 pb-2 mb-5">Projects</h1>

      {/* Group 1 */}
      <div className="flex flex-col md:flex-row justify-between max-w-4xl mx-auto gap-6 w-full">
        {/* Card 1 */}
